...
# Same product IDs as 0005_fix_demo_product_titles_utf8
PRODUCT_IDS = [
...
def fix_sku_names(apps, schema_editor):
    ...
    for pid in PRODUCT_IDS:
        ...
        skus = list(Sku.objects.filter(product_id=pid, deleted=False).order_by('id'))
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('b2b_api', '0005_fix_demo_product_titles_utf8'),
    ]
